...
def createProject():
	...
	git = False
	path = raw_input("Destination : ")
	repo = ""
	devmode = True

	CLEAN_TEXT = "find -maxdepth 1 ! -name proj.py ! -name b ! -name . -exec rm -rv {} \;"

	if devmode:
		os.system("touch clean")
		cleanup = open("clean", "w")
		cleanup.write(CLEAN_TEXT)
		cleanup.close()
		os.system("chmod 777 clean")
